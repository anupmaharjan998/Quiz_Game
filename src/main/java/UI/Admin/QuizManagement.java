...
//        headerPanel.add(addQuestionButton);
    ...
    private void openAddQuestionDialog() {
        ...
        List<LevelModel> levels = getLevels();
        JComboBox<LevelModel> levelDropdown = new JComboBox<>(levels.toArray(new LevelModel[0])); // Populate JComboBox
        ...
        saveButton.addActionListener(e -> {
            ...
            String level_id = ((LevelModel) levelDropdown.getSelectedItem()).getLevelId(); // Get the actual value
    ...
    private void editQuestion(String id) {
        Question question = questionDAO.getQuestionsById(id);
        ...
        List<LevelModel> levels = getLevels(); // Assuming this method returns a List<LevelModel>
        JComboBox<LevelModel> levelDropdown = new JComboBox<>(levels.toArray(new LevelModel[0]));
        ...
        saveButton.addActionListener(e -> {
            ...
            LevelModel selectedLevel = (LevelModel) levelDropdown.getSelectedItem();
    ...
    private List<LevelModel> getLevels() {
    ...
    private void navigateToDashboard() {
        ...
        new AdminDashboard(); // Create an instance of the Dashboard
